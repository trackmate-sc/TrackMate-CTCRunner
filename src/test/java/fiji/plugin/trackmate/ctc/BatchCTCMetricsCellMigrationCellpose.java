 ...
 *
 */
public class BatchCTCMetricsCellMigrationCellpose
{
	...
	public static void main( final String[] args ) throws IOException
	{
		...
		try (final Context context = new Context())
		{
			...
			// Configure detection.
			final SpotDetectorFactoryBase< ? > detectorFactory = new CellposeDetectorFactory<>();
			final Map< String, Object > detectorSettings = detectorFactory.getDefaultSettings();
			detectorSettings.put( CellposeDetectorFactory.KEY_CELLPOSE_PYTHON_FILEPATH, "C:\\Users\\tinevez\\anaconda3\\envs\\cellpose_biop_gpu\\python.exe" );
			detectorSettings.put( CellposeDetectorFactory.KEY_CELL_DIAMETER, 23. );
			detectorSettings.put( CellposeDetectorFactory.KEY_USE_GPU, true );
			detectorSettings.put( CellposeDetectorFactory.KEY_CELLPOSE_MODEL, CellposeSettings.PretrainedModel.NUCLEI );
			detectorSettings.put( CellposeDetectorFactory.KEY_OPTIONAL_CHANNEL_2, 0 );
			detectorSettings.put( DetectorKeys.KEY_TARGET_CHANNEL, 0 );
